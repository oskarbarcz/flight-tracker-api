Feature: Remove flights from rotation
  ...
  Scenario: As operations I cannot remove a flight in non-created status from a rotation
    Given I am signed in as "operations"
    When I send a "DELETE" request to "/api/v1/flight/48760636-9520-4863-b32f-f3618556feb7/rotation/bd8f2d64-a647-42da-be63-c6589915e6c9"
  ...
  Scenario: As operations I cannot remove a non-existent flight from a rotation
    Given I am signed in as "operations"
    When I send a "DELETE" request to "/api/v1/flight/9303a459-72f0-453a-ac3e-54e6eff5a29a/rotation/bd8f2d64-a647-42da-be63-c6589915e6c9"
  ...
  Scenario: As operations I cannot remove a flight with incorrect ID from a rotation
    Given I am signed in as "operations"
    When I send a "DELETE" request to "/api/v1/flight/incorrect-uuid/rotation/bd8f2d64-a647-42da-be63-c6589915e6c9"
    Then the response status should be 400
    And the response body should contain:
      """json
      {
  ...
  Scenario: As operations I cannot remove a flight from a non-existent rotation
    Given I am signed in as "operations"
    When I send a "DELETE" request to "/api/v1/flight/e91e13a9-09d8-48bf-8453-283cef467b88/rotation/49c8e76d-eccc-44b0-accb-4f0822c4c311"
    Then the response status should be 404
    And the response body should contain:
      """json
      {
  ...
  Scenario: As operations I cannot remove a flight from a rotation with incorrect ID
    Given I am signed in as "operations"
    When I send a "DELETE" request to "/api/v1/flight/e91e13a9-09d8-48bf-8453-283cef467b88/rotation/incorrect-uuid"
    Then the response status should be 400
    And the response body should contain:
      """json
      {

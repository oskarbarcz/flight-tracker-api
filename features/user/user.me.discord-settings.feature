Feature: Manage own Discord settings
  ...
  Scenario: As a cabin crew I cannot set briefings to a value that is not a boolean
    Given I am signed in as "cabin crew"
    When I send a "PATCH" request to "/api/v1/user/me/discord-settings" with body:
      """json
      {
  ...
  Scenario: As a cabin crew I cannot change Discord settings with an empty payload
    Given I am signed in as "cabin crew"
    When I send a "PATCH" request to "/api/v1/user/me/discord-settings" with body:
      """json
      {}

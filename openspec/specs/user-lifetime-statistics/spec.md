...
Expose a pilot's non-time-scoped flight statistics: lifetime totals, personal records, and
breakdowns per aircraft type, per airport, and per geography, plus their most-flown type and
airline. Read from the projections maintained by `flight-statistics-accrual`, scoped to the
authenticated pilot.

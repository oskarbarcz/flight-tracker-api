...
Record each shipment's own origin and final destination independent of the flight carrying it,
so the flight may be the whole of a journey or one leg of it. Covers the role a shipment plays
on the flight, the onward carrier and connection time where it continues beyond the arrival, the
air waybill prefix that shows who raised it, and the load units built to transfer intact to a
single point beyond.

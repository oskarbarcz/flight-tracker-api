...
Store and serve the latest raw METAR/TAF weather per airport, keep an airport watched
and its weather refreshed while any flight that references it is active (checked-in
through taxiing-in), and expose the stored weather via a public read endpoint.

# aircraft-hold-assignment

## Purpose

Assign to an aircraft one of the hold variants its airframe type offers, through a request of
its own rather than as part of creating or editing the aircraft, and resolve the variant in
force for any aircraft — falling back to the type's default where none is assigned, where the
assignment names a variant the data no longer offers, or where the assignment is removed.

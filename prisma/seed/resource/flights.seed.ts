...
async function loadAAL4905(tx: Prisma.TransactionClient): Promise<void> {
  const ual4905 = {
    ...
    aircraftId: '6c48d613-6582-49de-afbb-89fdc7cac0b7', // N718AN B77W
  ...
  await tx.flightEvent.createMany({
    data: [
      ...
      {
        id: '59d90e91-132c-4f76-b39d-394e96385dc8',
        actorId: null,
        flightId: flight.id,
        type: FlightEventType.LivePositionReceived,
        scope: FlightEventScope.user,
        createdAt: new Date('2025-01-01 12:01'),
      },
      {
...
async function loadAAL4907(tx: Prisma.TransactionClient): Promise<void> {
  const ual4907 = {
    ...
    status: FlightStatus.Created,
    tracking: FlightTracking.Public,
    aircraftId: 'ed247c36-58f0-43ff-81fd-ffae548a73e2', // N719AN B77W
    operatorId: '1f630d38-ad24-47cc-950b-3783e71bbd10', // American Airlines
    timesheet: {
      scheduled: {
        offBlockTime: new Date('2025-01-01 13:00'),
...
async function loadAAL4908(tx: Prisma.TransactionClient): Promise<void> {
  const data = {
    ...
    tracking: FlightTracking.Public,
    aircraftId: 'e7c6c5e3-84ff-4c5b-a40c-79f178c5b379', // N720AN B77W
    operatorId: '1f630d38-ad24-47cc-950b-3783e71bbd10', // American Airlines
    timesheet: {
      scheduled: {
        offBlockTime: new Date('2025-01-01 13:00'),
...
async function loadAAL4909(tx: Prisma.TransactionClient): Promise<void> {
  const data = {
    ...
    tracking: FlightTracking.Public,
    aircraftId: 'a2f425e0-2db0-4d8f-8c4c-b3a95d51eb24', // N721AN B77W
    operatorId: '1f630d38-ad24-47cc-950b-3783e71bbd10', // American Airlines
    timesheet: {
      scheduled: {
        offBlockTime: new Date('2025-01-01 13:00'),
...
async function loadAAL4910(tx: Prisma.TransactionClient): Promise<void> {
  const data = {
    ...
    tracking: FlightTracking.Public,
    aircraftId: 'ffe14007-9147-40a1-a228-573c9c87a2e7', // N722AN B77W
    operatorId: '1f630d38-ad24-47cc-950b-3783e71bbd10', // American Airlines
    timesheet: {
      scheduled: {
        offBlockTime: new Date('2025-01-01 13:00'),
...
async function loadAAL4911(tx: Prisma.TransactionClient): Promise<void> {
  const data = {
    ...
    tracking: FlightTracking.Public,
    aircraftId: '0fad1757-d650-4a52-b047-f29e9ea5c067', // N723AN B77W
    operatorId: '1f630d38-ad24-47cc-950b-3783e71bbd10', // American Airlines
    timesheet: {
      scheduled: {
        offBlockTime: new Date('2025-01-01 13:00'),
...
async function loadAAL4912(tx: Prisma.TransactionClient): Promise<void> {
  const data = {
    ...
    tracking: FlightTracking.Public,
    aircraftId: '8694eb6d-83e4-4f24-8a72-b67523b4d6bf', // N724AN B77W
    operatorId: '1f630d38-ad24-47cc-950b-3783e71bbd10', // American Airlines
    timesheet: {
      scheduled: {
        offBlockTime: new Date('2025-01-01 13:00'),
  ...
  await tx.flightEvent.createMany({
    data: [
      ...
      },
      {
        ...
        type: FlightEventType.LivePositionReceived,
        scope: FlightEventScope.user,
        createdAt: new Date('2025-01-01 13:11'),
      },
      {
...
async function loadAAL4914(tx: Prisma.TransactionClient): Promise<void> {
  const data = {
    ...
    tracking: FlightTracking.Public,
    aircraftId: '3c3f3402-cdb1-4716-9e02-1fe3df12e0e4', // N725AN B77W
    operatorId: '1f630d38-ad24-47cc-950b-3783e71bbd10', // American Airlines
    timesheet: {
      scheduled: {
        offBlockTime: new Date('2025-01-01 13:00'),
...
async function loadAAL4915(tx: Prisma.TransactionClient): Promise<void> {
  const data = {
    ...
    tracking: FlightTracking.Public,
    aircraftId: '8f27ca75-01e0-4a3f-bcf2-f838e02b9af9', // N726AN B77W
    operatorId: '1f630d38-ad24-47cc-950b-3783e71bbd10', // American Airlines
    timesheet: {
      scheduled: {
        offBlockTime: new Date('2025-01-01 13:00'),
...
async function loadAAL4916(tx: Prisma.TransactionClient): Promise<void> {
  const data = {
    ...
    tracking: FlightTracking.Public,
    aircraftId: '69811511-fa34-4837-ab5d-dd480aeab8b6', // N727AN B77W
    operatorId: '1f630d38-ad24-47cc-950b-3783e71bbd10', // American Airlines
    timesheet: {
      scheduled: {
        offBlockTime: new Date('2025-01-01 13:00'),
...
async function loadAAL4917(tx: Prisma.TransactionClient): Promise<void> {
  ...
  await tx.flightEvent.createMany({
    data: [
      ...
      {
        id: '1bb8224d-9900-4841-95de-ea47daef5a57',
        actorId: null,
        flightId: flight.id,
        type: FlightEventType.LivePositionReceived,
        scope: FlightEventScope.user,
...
async function loadAAL4918(tx: Prisma.TransactionClient): Promise<void> {
  const data = {
    ...
    status: FlightStatus.OffboardingFinished,
    tracking: FlightTracking.Public,
    aircraftId: '7e059d96-260c-44e3-a08c-a216cb76398b', // N729AN B77W
    operatorId: '1f630d38-ad24-47cc-950b-3783e71bbd10', // American Airlines
    timesheet: {
      scheduled: {
        offBlockTime: new Date('2025-01-01 13:00'),
...
async function loadAAL4919(tx: Prisma.TransactionClient): Promise<void> {
  const data = {
    ...
    status: FlightStatus.OffboardingFinished,
    tracking: FlightTracking.Public,
    aircraftId: 'b0ea1829-61ea-4b50-8bf6-bfccfb4fe5c7', // N730AN B77W
    operatorId: '1f630d38-ad24-47cc-950b-3783e71bbd10', // American Airlines
    timesheet: {
      scheduled: {
        offBlockTime: new Date('2025-01-01 13:00'),
...
async function loadDLH40(tx: Prisma.TransactionClient): Promise<void> {
  ...
  await tx.flightEvent.createMany({
    data: [
      {
        id: 'a13892d7-cfe9-42d0-96b7-0d61a885b244',
        actorId: null,
        flightId: flight.id,
        type: FlightEventType.LivePositionReceived,
        scope: FlightEventScope.user,
...
async function loadDLH102(tx: Prisma.TransactionClient): Promise<void> {
  const data = {
    ...
    captainId: 'fcf6f4bc-290d-43a9-843c-409cd47e143d',
    status: FlightStatus.InCruise,
    aircraftId: 'ed7ed4bb-95ff-4e79-9331-11212ef727ec', // D-AIMG A339
    operatorId: '40b1b34e-aea1-4cec-acbe-f2bf97c06d7d', // Lufthansa,
    timesheet: {
      scheduled: {
        offBlockTime: new Date('2025-01-01 13:00'),
  ...
  await tx.flightEvent.createMany({
    data: [
      ...
      },
      {
        ...
        type: FlightEventType.LivePositionReceived,
        scope: FlightEventScope.user,
        createdAt: new Date('2025-01-01 13:26'),
      },
      {
...
async function loadDLH880(tx: Prisma.TransactionClient): Promise<void> {
  const data = {
    ...
    status: FlightStatus.InCruise,
    tracking: FlightTracking.Public,
    aircraftId: 'cfedcfae-6e80-4801-8a89-12b2430c908b', // D-AIML A339
    operatorId: '40b1b34e-aea1-4cec-acbe-f2bf97c06d7d', // Lufthansa
    timesheet: {
      scheduled: {
...
async function loadDLH103(tx: Prisma.TransactionClient): Promise<void> {
  const data = {
    ...
    captainId: 'fcf6f4bc-290d-43a9-843c-409cd47e143d',
    status: FlightStatus.TaxiingIn,
    aircraftId: '5637d186-d9e4-45e4-9940-ae6f6552c9ae', // D-AIMH A339
    operatorId: '40b1b34e-aea1-4cec-acbe-f2bf97c06d7d', // Lufthansa
    timesheet: {
      scheduled: {
        offBlockTime: new Date('2025-01-01 13:00'),

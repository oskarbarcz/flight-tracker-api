...
const MICHAEL = '629be07f-5e65-429a-9d69-d34b99185f50';
      ...
      legs: [
        {
          ...
          departureId: EDDF,
          arrivalId: KJFK,
          offBlockTime: new Date('2025-02-01T12:00:00.000Z'),
          onBlockTime: new Date('2025-02-01T20:00:00.000Z'),
          flightId: null,
        },
        {
          ...
          departureId: KJFK,
          arrivalId: EDDF,
          offBlockTime: new Date('2025-02-01T22:00:00.000Z'),
          onBlockTime: new Date('2025-02-02T06:00:00.000Z'),
          flightId: null,
        },
      ],
    },
      ...
      legs: [
        {
          ...
          departureId: EDDF,
          arrivalId: KJFK,
          offBlockTime: new Date('2025-02-02T12:00:00.000Z'),
          onBlockTime: new Date('2025-02-02T20:00:00.000Z'),
          flightId: null,
        },
        {
          ...
          departureId: KJFK,
          arrivalId: EDDF,
          offBlockTime: new Date('2025-02-02T22:00:00.000Z'),
          onBlockTime: new Date('2025-02-03T06:00:00.000Z'),
          flightId: null,
        },
      ],
    },
    {
      ...
      legs: [
        ...
        },
        {
          ...
          onBlockTime: new Date('2025-02-04T06:00:00.000Z'),
          flightId: null,
        },
      ],
    },
    {
      id: '5cc591de-a9b9-483d-a7e4-a850464af934',
      name: 'FRA-JFK-FRA 2025-02-04',
      operatorId: LUFTHANSA,
      pilotId: MICHAEL,
      createdById: ALICE,
      status: 'draft',
      ...
      legs: [
        {
          id: 'e55b1003-63f8-419c-9554-2a71ce95b50f',
          flightNumber: 'LH400',
          departureId: EDDF,
          arrivalId: KJFK,
          offBlockTime: new Date('2025-02-04T12:00:00.000Z'),
          onBlockTime: new Date('2025-02-04T20:00:00.000Z'),
          flightId: null,
        },
      ],
    },

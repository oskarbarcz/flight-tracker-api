...
export class GetFlightNotocAction {
  ...
  @ApiOperation({
    ...
    description:
      ...
      'response codes and their drills are derived from the published drill chart. Loading ' +
      'positions are a convention of this system, not a published designation. Cabin crew ' +
      'may read the notification only for a flight they captain.',
  })
  @ApiBearerAuth('jwt')

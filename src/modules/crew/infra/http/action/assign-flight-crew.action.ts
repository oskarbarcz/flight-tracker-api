...
import { AssignCrewMemberToFlightCommand } from '../../../application/command/assign-crew-member-to-flight.command';
import { ListFlightCrewQuery } from '../../../application/query/list-flight-crew.query';
import { GetFlightQuery } from '../../../../flights/application/query/get-flight.query';
import { assertCrewIsModifiable } from '../../../../flights/model/crew-assignment.policy';

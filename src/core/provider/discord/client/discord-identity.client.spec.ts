...
const REDIRECT_URI = 'https://app.mypreflight.io/auth/discord/callback';
const CONFIG = {
...
describe('parseAllowedRedirectUris', () => {
  it('splits and trims the configured list', () => {
    expect(
      parseAllowedRedirectUris(
        ' http://localhost:5173/auth/discord/callback , https://app.mypreflight.io/auth/discord/callback ',
      ),
    ).toEqual([
      'http://localhost:5173/auth/discord/callback',
      'https://app.mypreflight.io/auth/discord/callback',
    ]);
  });
